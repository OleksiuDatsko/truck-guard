...
The **Ingestor Service** is a high-performance entry point for IoT data in the TruckGuard ecosystem. It acts as a specialized gateway designed to handle massive streams of data from cameras and sensors with minimal latency.
